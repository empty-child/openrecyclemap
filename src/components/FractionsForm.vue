  ...
  <div class="tags_window">
    <div class="tags_window_inner">
      <div class="node_type">
        ...
        <div class="node_type_choice">
          <div
            ...
            :class="[
              'type_btn type_waste',
              { type_active: type_btn === 'waste' },
            ]"
          >
            {{ $t("message.wasteDisposal") }}
          </div>
          <div
            @click="
            ...
            "
            :class="[
              'type_btn type_recycle',
              { type_active: type_btn === 'recycle' },
            ]"
          >
            {{ $t("message.recyclingContainer") }}
          </div>
          <div
            @click="
              waste_disposal = false;
              type_btn = 'org';
            "
            :class="['type_btn type_org', { type_active: type_btn === 'org' }]"
          >
            {{ $t("message.recyclingOrganization") }}
          </div>
        </div>
      </div>
      ...
      <div class="name_box" v-if="type_btn === 'org'">
        ...
        <v-text-field
          :label="$t('message.organizationName')"
          solo
          v-model="name"
        ></v-text-field>
      </div>
      ...
      <div class="add_mode_steps">
        <div class="btn btn_gray" @click="cancelAddMode">
          {{ $t("button.cancel") }}
        </div>
        <div class="btn btn_green btn_add_next" @click="saveData">
          {{ $t("button.save") }}
        </div>
      </div>
    </div>
  ...
  created() {
    if (this.selected) {
      ...
      this.type_btn = this.waste_disposal
        ...
        : "recycle";
      if (!this.waste_disposal) {
        this.selected.fractions.forEach(
          (item) => (this.recycling[item] = true)
        );
      }
